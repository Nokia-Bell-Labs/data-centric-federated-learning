...
# post_args = ['1pamap_2senc_3large_c8|20_e3_a5_b3_g0_flpa1000_mr0|0']
# post_args = post_args+ ['1uci_har_2senc_3large_c8|20_e3_a5_b3_g0_flpa1000_mr0|0']
# post_args = post_args+ ['1motion_2senc_3large_c8|20_e3_a5_b3_g0_flpa1000_mr0|0']
post_args = ['1pamap_2senc_3medium_c8|20_e3_a5_b3_g0_flpa1000_mr0|0']
post_args = post_args+ ['1uci_har_2senc_3medium_c8|20_e3_a5_b3_g0_flpa1000_mr0|0']
post_args = post_args+ ['1motion_2senc_3medium_c8|20_e3_a5_b3_g0_flpa1000_mr0|0']
# post_args = ['1pamap_2senc_3small_c8|20_e3_a5_b3_g0_flpa1000_mr0|0']
# post_args = post_args+ ['1uci_har_2senc_3small_c8|20_e3_a5_b3_g0_flpa1000_mr0|0']
# post_args = post_args+ ['1motion_2senc_3small_c8|20_e3_a5_b3_g0_flpa1000_mr0|0']

# post_args = ['1pamap_2effi_3medium_c5|100_e3_a5_b3_g0'] + post_args
...
#### single ####
text_ = '54.5% higher accuracy'
col.annotate('', xy=(0.84, 27000), xycoords='data',
            xytext=(0.54, 27000), textcoords='data',
            arrowprops=dict(arrowstyle="->, head_width=0.3", color='b', lw=2.5, ls='-'))
col.annotate(text_, xy=(0.66, 18000), xycoords='data', ha='center', color='b', size=9)

text_ = '59.3%\nlower\nlatency'
col.annotate('', xy=(0.545, 28000), xycoords='data',
            xytext=(0.545, 65000), textcoords='data',
            arrowprops=dict(arrowstyle="->, head_width=0.3", color='b', lw=2.5,ls='-'))
col.annotate(text_, xy=(0.578, 39000), xycoords='data', ha='center', color='b', size=9)
...
for idx in range(3):
    ...
    if idx ==0:
        ...
        col.text(x_iot[idx]*0.92, y1_iot[idx]+5000, "UCIHAR", size=anno_text_size)
    else :
